...
The libraries target .NET Standard 2.0 and .NET Framework 4.6.1. The tests (so
the library) runs with the supported runtimes:

- .NET 5.0
- .NET Core 3.1
- .NET Framework 4.8 or Mono (latest on CI)
- .NET Framework 4.6.1 or Mono (latest on CI)
